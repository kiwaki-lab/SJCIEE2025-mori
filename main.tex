...
%
\bibitem{hypHC} 
Chami et. al., ``From trees to continuous embeddings and back: Hyperbolic hierarchical clustering,''%From Trees to Continuous Embeddings and Back:  Hyperbolic Hierarchical Clustering
\textsl{NeurIPS}, 33, pp.~15065-15076, 2020.
%
\bibitem{dasgupta}
Dasgupta, ``A cost function for similarity-based hierarchical clustering,''%A Cost Function for Similarity-Based Hierarchical Clustering
